+function () {
  ...
  function _validateId(photoPost) {
    if (typeof (photoPost.id) != 'string') {
      return false;
    }
    if (photoPosts.some(Post => photoPost.id === Post.id)) {
      return false;
    }
    return true;
  }

  function _validateDescription(photoPost){
  ...
  function _validateCreatedAt(photoPost){
  ...
  function _validateAutor(photoPost){
  ...
  function _validatePhotoLink(photoPost){
  ...
  function _validateHashtags(photoPost){
  ...
  function _validateLikes(photoPost){
  ...
  function validatePhotoPost(photoPost) {
    if (photoPost != undefined){
      return _validateId(photoPost)
      & _validateDescription(photoPost)
      & _validateCreatedAt(photoPost)
      & _validateAutor(photoPost)
      & _validatePhotoLink(photoPost)
      & _validateHashtags (photoPost)
      & _validateLikes(photoPost);
    }
  };
    ...
    if (filterConfig) {
      ...
      for (var i = skip; i < allLen; i++) {
        ...
        if (filterConfig.hashtags) {
          isTags = contains(photoPosts[i].hashtags, filterConfig.hashtags);
        }
        else {
          isTags = true;
        }
        if (filterConfig.author != null) {
          ...
          if (photoPosts[i].author == filterConfig.author && (isTags) ) {
